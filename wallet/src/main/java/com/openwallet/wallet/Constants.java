...
import com.openwallet.core.coins.IntercoinMain;
...
public class Constants {
    ...
    public static final String BINARY_URL = "https://github.com/Intercoin-Developer/openwallet/releases";

    public static final String VERSION_URL = "https://openwallet.xyz/version";
    public static final String SUPPORT_EMAIL = "intercoin.developer@gmail.com";

    // TODO move to resource files
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            new CoinAddress(IntercoinMain.get(),    new ServerAddress("intercoin.tk", 5048),
                                                    new ServerAddress("intercoin.tk", 5048))
    );
    ...
    static {
        ...
        COINS_ICONS.put(CoinID.INTERCOIN_MAIN.getCoinType(), R.drawable.intercoin);

        COINS_BLOCK_EXPLORERS = new HashMap<CoinType, String>();
        COINS_BLOCK_EXPLORERS.put(CoinID.INTERCOIN_MAIN.getCoinType(), "https://explorer.intercoin.tk/tx/%s");
    }

    public static final CoinType DEFAULT_COIN = IntercoinMain.get();
    public static final List<CoinType> DEFAULT_COINS = ImmutableList.of((CoinType) IntercoinMain.get());
